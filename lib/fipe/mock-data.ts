...
export const FIPE_MODELS: FipeModel[] = [
  ...
  // === MOTOS ===
  // Honda Motos (brandId: 101)
  { id: '1001', name: 'CG 160', slug: 'cg-160', brandId: '101', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1002', name: 'Biz 125', slug: 'biz-125', brandId: '101', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1003', name: 'Pop 110i', slug: 'pop-110i', brandId: '101', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1004', name: 'CB 500F', slug: 'cb-500f', brandId: '101', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1005', name: 'CB 650R', slug: 'cb-650r', brandId: '101', years: [2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1006', name: 'XRE 300', slug: 'xre-300', brandId: '101', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1007', name: 'NXR 160 Bros', slug: 'nxr-160-bros', brandId: '101', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1008', name: 'PCX 160', slug: 'pcx-160', brandId: '101', years: [2022, 2023, 2024, 2025] },
  { id: '1009', name: 'Elite 125', slug: 'elite-125', brandId: '101', years: [2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1010', name: 'CBR 1000RR', slug: 'cbr-1000rr', brandId: '101', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  // Yamaha (brandId: 102)
  { id: '1020', name: 'Factor 150', slug: 'factor-150', brandId: '102', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1021', name: 'Fazer 250', slug: 'fazer-250', brandId: '102', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1022', name: 'Crosser 150', slug: 'crosser-150', brandId: '102', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1023', name: 'Lander 250', slug: 'lander-250', brandId: '102', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1024', name: 'MT-03', slug: 'mt-03', brandId: '102', years: [2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1025', name: 'MT-07', slug: 'mt-07', brandId: '102', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1026', name: 'MT-09', slug: 'mt-09', brandId: '102', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1027', name: 'YZF-R3', slug: 'yzf-r3', brandId: '102', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1028', name: 'Tenere 700', slug: 'tenere-700', brandId: '102', years: [2021, 2022, 2023, 2024, 2025] },
  { id: '1029', name: 'NMAX 160', slug: 'nmax-160', brandId: '102', years: [2020, 2021, 2022, 2023, 2024, 2025] },
  // Suzuki (brandId: 103)
  { id: '1030', name: 'GSX-S750', slug: 'gsx-s750', brandId: '103', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1031', name: 'V-Strom 650', slug: 'v-strom-650', brandId: '103', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1032', name: 'V-Strom 1050', slug: 'v-strom-1050', brandId: '103', years: [2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1033', name: 'GSX-R 1000', slug: 'gsx-r-1000', brandId: '103', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1034', name: 'Hayabusa', slug: 'hayabusa', brandId: '103', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  // Kawasaki (brandId: 104)
  { id: '1040', name: 'Z400', slug: 'z400', brandId: '104', years: [2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1041', name: 'Z650', slug: 'z650', brandId: '104', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1042', name: 'Z900', slug: 'z900', brandId: '104', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1043', name: 'Ninja 400', slug: 'ninja-400', brandId: '104', years: [2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1044', name: 'Ninja 650', slug: 'ninja-650', brandId: '104', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1045', name: 'Ninja ZX-10R', slug: 'ninja-zx-10r', brandId: '104', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1046', name: 'Versys 650', slug: 'versys-650', brandId: '104', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  // BMW Motorrad (brandId: 105)
  { id: '1050', name: 'G 310 R', slug: 'g-310-r', brandId: '105', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1051', name: 'G 310 GS', slug: 'g-310-gs', brandId: '105', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1052', name: 'F 850 GS', slug: 'f-850-gs', brandId: '105', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1053', name: 'R 1250 GS', slug: 'r-1250-gs', brandId: '105', years: [2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1054', name: 'S 1000 RR', slug: 's-1000-rr', brandId: '105', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  // Harley-Davidson (brandId: 106)
  { id: '1060', name: 'Iron 883', slug: 'iron-883', brandId: '106', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1061', name: 'Forty-Eight', slug: 'forty-eight', brandId: '106', years: [2018, 2019, 2020, 2021, 2022] },
  { id: '1062', name: 'Fat Bob', slug: 'fat-bob', brandId: '106', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1063', name: 'Street Bob', slug: 'street-bob', brandId: '106', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1064', name: 'Pan America', slug: 'pan-america', brandId: '106', years: [2021, 2022, 2023, 2024, 2025] },
  // Triumph (brandId: 107)
  { id: '1070', name: 'Street Triple', slug: 'street-triple', brandId: '107', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1071', name: 'Tiger 900', slug: 'tiger-900', brandId: '107', years: [2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1072', name: 'Tiger 1200', slug: 'tiger-1200', brandId: '107', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1073', name: 'Bonneville T120', slug: 'bonneville-t120', brandId: '107', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  // Ducati (brandId: 108)
  { id: '1080', name: 'Monster', slug: 'monster', brandId: '108', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1081', name: 'Multistrada V4', slug: 'multistrada-v4', brandId: '108', years: [2021, 2022, 2023, 2024, 2025] },
  { id: '1082', name: 'Panigale V4', slug: 'panigale-v4', brandId: '108', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1083', name: 'Scrambler', slug: 'scrambler', brandId: '108', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  // Royal Enfield (brandId: 109)
  { id: '1090', name: 'Meteor 350', slug: 'meteor-350', brandId: '109', years: [2021, 2022, 2023, 2024, 2025] },
  { id: '1091', name: 'Classic 350', slug: 'classic-350', brandId: '109', years: [2021, 2022, 2023, 2024, 2025] },
  { id: '1092', name: 'Himalayan', slug: 'himalayan', brandId: '109', years: [2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  // Shineray (brandId: 110)
  { id: '1100', name: 'Worker 150', slug: 'worker-150', brandId: '110', years: [2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1101', name: 'Jet 125', slug: 'jet-125', brandId: '110', years: [2020, 2021, 2022, 2023, 2024, 2025] },
  // Dafra (brandId: 111)
  { id: '1110', name: 'Apache 200', slug: 'apache-200', brandId: '111', years: [2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1111', name: 'NH 190', slug: 'nh-190', brandId: '111', years: [2020, 2021, 2022, 2023, 2024, 2025] },
  // Haojue (brandId: 112)
  { id: '1120', name: 'DR 160', slug: 'dr-160', brandId: '112', years: [2021, 2022, 2023, 2024, 2025] },
  { id: '1121', name: 'NK 150', slug: 'nk-150', brandId: '112', years: [2020, 2021, 2022, 2023, 2024, 2025] },
