...
export const FIPE_BRANDS: FipeBrand[] = [
  ...
  { id: '34', name: 'Chery', slug: 'chery', categoryId: '1' },
  { id: '35', name: 'Effa', slug: 'effa', categoryId: '1' },
  { id: '36', name: 'Chrysler', slug: 'chrysler', categoryId: '1' },
  { id: '37', name: 'Dodge', slug: 'dodge', categoryId: '1' },
  { id: '38', name: 'Ssangyong', slug: 'ssangyong', categoryId: '1' },
  { id: '39', name: 'Ferrari', slug: 'ferrari', categoryId: '1' },
  { id: '40', name: 'Lamborghini', slug: 'lamborghini', categoryId: '1' },
  { id: '41', name: 'Maserati', slug: 'maserati', categoryId: '1' },
  { id: '42', name: 'Aston Martin', slug: 'aston-martin', categoryId: '1' },
  { id: '43', name: 'Rolls-Royce', slug: 'rolls-royce', categoryId: '1' },
  { id: '44', name: 'Bentley', slug: 'bentley', categoryId: '1' },
  { id: '45', name: 'McLaren', slug: 'mclaren', categoryId: '1' },
  { id: '46', name: 'Geely', slug: 'geely', categoryId: '1' },
  { id: '47', name: 'GAC', slug: 'gac', categoryId: '1' },
  { id: '48', name: 'ZEEKR', slug: 'zeekr', categoryId: '1' },
  { id: '49', name: 'Jaecoo', slug: 'jaecoo', categoryId: '1' },
  { id: '50', name: 'Shineray', slug: 'shineray-carros', categoryId: '1' },
  { id: '51', name: 'Hitech Electric', slug: 'hitech-electric', categoryId: '1' },
  { id: '52', name: 'Foton', slug: 'foton', categoryId: '1' },
  // Motos (categoryId: 2)
  ...
  { id: '121', name: 'Benelli', slug: 'benelli', categoryId: '2' },
  { id: '122', name: 'Beta', slug: 'beta', categoryId: '2' },
  { id: '123', name: 'Moto Guzzi', slug: 'moto-guzzi', categoryId: '2' },
  { id: '124', name: 'Piaggio', slug: 'piaggio', categoryId: '2' },
  { id: '125', name: 'Vespa', slug: 'vespa', categoryId: '2' },
  { id: '126', name: 'Bajaj', slug: 'bajaj', categoryId: '2' },
  { id: '127', name: 'Hero', slug: 'hero', categoryId: '2' },
  { id: '128', name: 'Sundown', slug: 'sundown', categoryId: '2' },
  { id: '129', name: 'Agrale', slug: 'agrale', categoryId: '2' },
  { id: '130', name: 'Amazonas', slug: 'amazonas', categoryId: '2' },
  { id: '131', name: 'Bull', slug: 'bull', categoryId: '2' },
  { id: '132', name: 'Dafra', slug: 'dafra-motos', categoryId: '2' },
  { id: '133', name: 'Dayang', slug: 'dayang', categoryId: '2' },
  { id: '134', name: 'Dayun', slug: 'dayun', categoryId: '2' },
  { id: '135', name: 'Gas Gas', slug: 'gas-gas', categoryId: '2' },
  { id: '136', name: 'Kymco', slug: 'kymco', categoryId: '2' },
  { id: '137', name: 'Lifan Motos', slug: 'lifan-motos', categoryId: '2' },
  { id: '138', name: 'MVK', slug: 'mvk', categoryId: '2' },
  { id: '139', name: 'Voltz', slug: 'voltz', categoryId: '2' },
  { id: '140', name: 'Super Soco', slug: 'super-soco', categoryId: '2' },
  { id: '141', name: 'Zontes', slug: 'zontes', categoryId: '2' },
  { id: '142', name: 'Peugeot Motos', slug: 'peugeot-motos', categoryId: '2' },
...
export const FIPE_MODELS: FipeModel[] = [
  // === CARROS ===
  // Fiat (brandId: 1) - Modelos vendidos no Brasil
  { id: '1', name: 'Uno', slug: 'uno', brandId: '1', years: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022] },
  { id: '2', name: 'Argo', slug: 'argo', brandId: '1', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '3', name: 'Cronos', slug: 'cronos', brandId: '1', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '4', name: 'Mobi', slug: 'mobi', brandId: '1', years: [2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '5', name: 'Toro', slug: 'toro', brandId: '1', years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '6', name: 'Strada', slug: 'strada', brandId: '1', years: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  ...
  { id: '9', name: 'Palio', slug: 'palio', brandId: '1', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017] },
  { id: '9a', name: 'Siena', slug: 'siena', brandId: '1', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017] },
  { id: '9b', name: 'Grand Siena', slug: 'grand-siena', brandId: '1', years: [2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021] },
  { id: '9c', name: 'Punto', slug: 'punto', brandId: '1', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017] },
  { id: '9d', name: 'Linea', slug: 'linea', brandId: '1', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016] },
  { id: '9e', name: 'Bravo', slug: 'bravo', brandId: '1', years: [2011, 2012, 2013, 2014, 2015, 2016] },
  { id: '9f', name: 'Doblo', slug: 'doblo', brandId: '1', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021] },
  { id: '9g', name: 'Fiorino', slug: 'fiorino', brandId: '1', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '9h', name: 'Ducato', slug: 'ducato', brandId: '1', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '9i', name: 'Freemont', slug: 'freemont', brandId: '1', years: [2012, 2013, 2014, 2015, 2016] },
  { id: '9j', name: '500', slug: '500', brandId: '1', years: [2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  // Volkswagen (brandId: 2) - Modelos vendidos no Brasil
  { id: '10', name: 'Gol', slug: 'gol', brandId: '2', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023] },
  { id: '11', name: 'Polo', slug: 'polo', brandId: '2', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '12', name: 'Virtus', slug: 'virtus', brandId: '2', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '13', name: 'T-Cross', slug: 't-cross', brandId: '2', years: [2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  ...
  { id: '16', name: 'Saveiro', slug: 'saveiro', brandId: '2', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '17', name: 'Amarok', slug: 'amarok', brandId: '2', years: [2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '17a', name: 'Voyage', slug: 'voyage', brandId: '2', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022] },
  { id: '17b', name: 'Fox', slug: 'fox', brandId: '2', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021] },
  { id: '17c', name: 'SpaceFox', slug: 'spacefox', brandId: '2', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018] },
  { id: '17d', name: 'CrossFox', slug: 'crossfox', brandId: '2', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018] },
  { id: '17e', name: 'Up!', slug: 'up', brandId: '2', years: [2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021] },
  { id: '17f', name: 'Golf', slug: 'golf', brandId: '2', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020] },
  { id: '17g', name: 'Jetta', slug: 'jetta', brandId: '2', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '17h', name: 'Tiguan', slug: 'tiguan', brandId: '2', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '17i', name: 'Tiguan Allspace', slug: 'tiguan-allspace', brandId: '2', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '17j', name: 'Passat', slug: 'passat', brandId: '2', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019] },
  { id: '17k', name: 'Fusca', slug: 'fusca', brandId: '2', years: [2013, 2014, 2015, 2016] },
  { id: '17l', name: 'Kombi', slug: 'kombi', brandId: '2', years: [2010, 2011, 2012, 2013, 2014] },
  // Ford (brandId: 3)
  ...
  // Chevrolet (brandId: 4) - Modelos vendidos no Brasil
  { id: '30', name: 'Onix', slug: 'onix', brandId: '4', years: [2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '31', name: 'Onix Plus', slug: 'onix-plus', brandId: '4', years: [2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '32', name: 'Tracker', slug: 'tracker', brandId: '4', years: [2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '33', name: 'S10', slug: 's10', brandId: '4', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '34', name: 'Montana', slug: 'montana', brandId: '4', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '35', name: 'Spin', slug: 'spin', brandId: '4', years: [2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '36', name: 'Equinox', slug: 'equinox', brandId: '4', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '37', name: 'Trailblazer', slug: 'trailblazer', brandId: '4', years: [2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '37a', name: 'Prisma', slug: 'prisma', brandId: '4', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019] },
  { id: '37b', name: 'Cobalt', slug: 'cobalt', brandId: '4', years: [2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020] },
  { id: '37c', name: 'Cruze', slug: 'cruze', brandId: '4', years: [2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: '37d', name: 'Celta', slug: 'celta', brandId: '4', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016] },
  { id: '37e', name: 'Classic', slug: 'classic', brandId: '4', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016] },
  { id: '37f', name: 'Corsa', slug: 'corsa', brandId: '4', years: [2010, 2011, 2012] },
  { id: '37g', name: 'Captiva', slug: 'captiva', brandId: '4', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017] },
  { id: '37h', name: 'Camaro', slug: 'camaro', brandId: '4', years: [2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '37i', name: 'Malibu', slug: 'malibu', brandId: '4', years: [2010, 2011, 2012, 2013, 2014, 2015] },
  { id: '37j', name: 'Sonic', slug: 'sonic', brandId: '4', years: [2012, 2013, 2014] },
  // Hyundai (brandId: 5)
  ...
  { id: '1001', name: 'CG 125 Fan', slug: 'cg-125-fan', brandId: '101', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018] },
  { id: '1001a', name: 'CG 125 Cargo', slug: 'cg-125-cargo', brandId: '101', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1002', name: 'CG 150 Fan', slug: 'cg-150-fan', brandId: '101', years: [2010, 2011, 2012, 2013, 2014, 2015] },
  { id: '1002a', name: 'CG 150 Titan', slug: 'cg-150-titan', brandId: '101', years: [2010, 2011, 2012, 2013, 2014, 2015] },
  { id: '1003', name: 'CG 160 Fan', slug: 'cg-160-fan', brandId: '101', years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1004', name: 'CG 160 Start', slug: 'cg-160-start', brandId: '101', years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1005', name: 'CG 160 Titan', slug: 'cg-160-titan', brandId: '101', years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1005a', name: 'CG 160 Cargo', slug: 'cg-160-cargo', brandId: '101', years: [2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1006', name: 'Biz 100', slug: 'biz-100', brandId: '101', years: [2010, 2011, 2012, 2013, 2014, 2015] },
  { id: '1007', name: 'Biz 110i', slug: 'biz-110i', brandId: '101', years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1008', name: 'Biz 125', slug: 'biz-125', brandId: '101', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1009', name: 'Pop 100', slug: 'pop-100', brandId: '101', years: [2010, 2011, 2012, 2013, 2014, 2015] },
  { id: '1010', name: 'Pop 110i', slug: 'pop-110i', brandId: '101', years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1011', name: 'XRE 190', slug: 'xre-190', brandId: '101', years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1012', name: 'XRE 300', slug: 'xre-300', brandId: '101', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1012a', name: 'XRE 300 Rally', slug: 'xre-300-rally', brandId: '101', years: [2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1013', name: 'NXR 125 Bros', slug: 'nxr-125-bros', brandId: '101', years: [2010, 2011, 2012, 2013, 2014, 2015] },
  { id: '1014', name: 'NXR 150 Bros', slug: 'nxr-150-bros', brandId: '101', years: [2010, 2011, 2012, 2013, 2014, 2015] },
  { id: '1015', name: 'NXR 160 Bros', slug: 'nxr-160-bros', brandId: '101', years: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1016', name: 'CB 250F Twister', slug: 'cb-250f-twister', brandId: '101', years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1017', name: 'CB 300R', slug: 'cb-300r', brandId: '101', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1018', name: 'CBR 250R', slug: 'cbr-250r', brandId: '101', years: [2011, 2012, 2013, 2014, 2015] },
  { id: '1019', name: 'CB 500F', slug: 'cb-500f', brandId: '101', years: [2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1020', name: 'CB 500X', slug: 'cb-500x', brandId: '101', years: [2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1021', name: 'CBR 500R', slug: 'cbr-500r', brandId: '101', years: [2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1022', name: 'CB 650F', slug: 'cb-650f', brandId: '101', years: [2015, 2016, 2017, 2018, 2019] },
  { id: '1023', name: 'CB 650R', slug: 'cb-650r', brandId: '101', years: [2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1024', name: 'CBR 650F', slug: 'cbr-650f', brandId: '101', years: [2015, 2016, 2017, 2018, 2019] },
  { id: '1025', name: 'CBR 650R', slug: 'cbr-650r', brandId: '101', years: [2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1026', name: 'CBR 1000RR Fireblade', slug: 'cbr-1000rr-fireblade', brandId: '101', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1027', name: 'PCX 150', slug: 'pcx-150', brandId: '101', years: [2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021] },
  { id: '1028', name: 'PCX 160', slug: 'pcx-160', brandId: '101', years: [2022, 2023, 2024, 2025] },
  { id: '1029', name: 'Elite 125', slug: 'elite-125', brandId: '101', years: [2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1030', name: 'ADV 150', slug: 'adv-150', brandId: '101', years: [2021, 2022, 2023, 2024, 2025] },
  { id: '1031', name: 'SH 150i', slug: 'sh-150i', brandId: '101', years: [2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1032', name: 'SH 300i', slug: 'sh-300i', brandId: '101', years: [2016, 2017, 2018, 2019, 2020] },
  { id: '1033', name: 'Africa Twin 1100', slug: 'africa-twin-1100', brandId: '101', years: [2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1034', name: 'NC 750X', slug: 'nc-750x', brandId: '101', years: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1035', name: 'Gold Wing', slug: 'gold-wing', brandId: '101', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1036', name: 'CTX 700N', slug: 'ctx-700n', brandId: '101', years: [2014, 2015, 2016, 2017, 2018] },
  { id: '1037', name: 'VT 750 Shadow', slug: 'vt-750-shadow', brandId: '101', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017] },
  { id: '1038', name: 'Lead 110', slug: 'lead-110', brandId: '101', years: [2010, 2011, 2012, 2013, 2014, 2015] },
  { id: '1039', name: 'Transalp 700', slug: 'transalp-700', brandId: '101', years: [2010, 2011, 2012, 2013, 2014] },
  // Yamaha (brandId: 102) - Segunda mais vendida no Brasil
  { id: '1040', name: 'YBR 125 Factor', slug: 'ybr-125-factor', brandId: '102', years: [2010, 2011, 2012, 2013, 2014, 2015] },
  { id: '1041', name: 'YBR 125 Factor E', slug: 'ybr-125-factor-e', brandId: '102', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016] },
  { id: '1042', name: 'Factor 125i', slug: 'factor-125i', brandId: '102', years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1043', name: 'Factor 150', slug: 'factor-150', brandId: '102', years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1044', name: 'Fazer 150', slug: 'fazer-150', brandId: '102', years: [2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1045', name: 'Fazer 250', slug: 'fazer-250', brandId: '102', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1046', name: 'YS 150 Fazer', slug: 'ys-150-fazer', brandId: '102', years: [2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1047', name: 'Crosser 150', slug: 'crosser-150', brandId: '102', years: [2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1048', name: 'Crosser 250', slug: 'crosser-250', brandId: '102', years: [2021, 2022, 2023, 2024, 2025] },
  { id: '1049', name: 'Lander 250', slug: 'lander-250', brandId: '102', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1050', name: 'XTZ 125', slug: 'xtz-125', brandId: '102', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016] },
  { id: '1051', name: 'XTZ 150', slug: 'xtz-150', brandId: '102', years: [2017, 2018, 2019, 2020, 2021] },
  { id: '1052', name: 'XTZ 250 Tenere', slug: 'xtz-250-tenere', brandId: '102', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1053', name: 'Fluo 125', slug: 'fluo-125', brandId: '102', years: [2022, 2023, 2024, 2025] },
  { id: '1054', name: 'Neo 115', slug: 'neo-115', brandId: '102', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016] },
  { id: '1055', name: 'Neo 125', slug: 'neo-125', brandId: '102', years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1056', name: 'NMAX 160', slug: 'nmax-160', brandId: '102', years: [2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1057', name: 'XMAX 250', slug: 'xmax-250', brandId: '102', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1058', name: 'MT-03', slug: 'mt-03', brandId: '102', years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1059', name: 'MT-07', slug: 'mt-07', brandId: '102', years: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1060', name: 'MT-09', slug: 'mt-09', brandId: '102', years: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1061', name: 'YZF-R1', slug: 'yzf-r1', brandId: '102', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1062', name: 'YZF-R3', slug: 'yzf-r3', brandId: '102', years: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1063', name: 'YZF-R6', slug: 'yzf-r6', brandId: '102', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020] },
  { id: '1064', name: 'YZF-R7', slug: 'yzf-r7', brandId: '102', years: [2022, 2023, 2024, 2025] },
  { id: '1065', name: 'Tenere 700', slug: 'tenere-700', brandId: '102', years: [2021, 2022, 2023, 2024, 2025] },
  { id: '1066', name: 'Tracer 900 GT', slug: 'tracer-900-gt', brandId: '102', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1067', name: 'Super Tenere 1200', slug: 'super-tenere-1200', brandId: '102', years: [2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1068', name: 'XJ6', slug: 'xj6', brandId: '102', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019] },
  { id: '1069', name: 'XT 660R', slug: 'xt-660r', brandId: '102', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018] },
  { id: '1070', name: 'Midnight Star 950', slug: 'midnight-star-950', brandId: '102', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017] },
  { id: '1071', name: 'Drag Star 650', slug: 'drag-star-650', brandId: '102', years: [2010, 2011, 2012, 2013, 2014, 2015, 2016] },
  { id: '1072', name: 'FZ25 Fazer', slug: 'fz25-fazer', brandId: '102', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  // Suzuki (brandId: 103)
  ...
  // Benelli (brandId: 121)
  { id: '1220', name: 'TNT 300', slug: 'tnt-300', brandId: '121', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1221', name: 'TNT 600', slug: 'tnt-600', brandId: '121', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1222', name: 'TRK 502', slug: 'trk-502', brandId: '121', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1223', name: 'Leoncino 500', slug: 'leoncino-500', brandId: '121', years: [2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1224', name: '752S', slug: '752s', brandId: '121', years: [2021, 2022, 2023, 2024, 2025] },
  // Beta (brandId: 122)
  { id: '1230', name: 'RR 300', slug: 'rr-300', brandId: '122', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1231', name: 'RR 350', slug: 'rr-350', brandId: '122', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1232', name: 'RR 450', slug: 'rr-450', brandId: '122', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  // Vespa (brandId: 125)
  { id: '1250', name: 'Primavera 150', slug: 'primavera-150', brandId: '125', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1251', name: 'Sprint 150', slug: 'sprint-150', brandId: '125', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1252', name: 'GTS 300', slug: 'gts-300', brandId: '125', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  // Bajaj (brandId: 126)
  { id: '1260', name: 'Dominar 400', slug: 'dominar-400', brandId: '126', years: [2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1261', name: 'Pulsar NS 200', slug: 'pulsar-ns-200', brandId: '126', years: [2018, 2019, 2020, 2021] },
  { id: '1262', name: 'Pulsar 180', slug: 'pulsar-180', brandId: '126', years: [2018, 2019, 2020, 2021] },
  // Sundown (brandId: 128)
  { id: '1280', name: 'MAX 125', slug: 'max-125', brandId: '128', years: [2010, 2011, 2012, 2013, 2014, 2015] },
  { id: '1281', name: 'STX 200', slug: 'stx-200', brandId: '128', years: [2010, 2011, 2012, 2013, 2014, 2015] },
  { id: '1282', name: 'Web 100', slug: 'web-100', brandId: '128', years: [2010, 2011, 2012, 2013, 2014, 2015] },
  { id: '1283', name: 'Hunter 125', slug: 'hunter-125', brandId: '128', years: [2010, 2011, 2012, 2013, 2014, 2015] },
  // Voltz (brandId: 139)
  { id: '1390', name: 'EV1', slug: 'ev1', brandId: '139', years: [2021, 2022, 2023, 2024, 2025] },
  { id: '1391', name: 'EVS', slug: 'evs', brandId: '139', years: [2022, 2023, 2024, 2025] },
  // Super Soco (brandId: 140)
  { id: '1400', name: 'TC', slug: 'tc', brandId: '140', years: [2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1401', name: 'CUx', slug: 'cux', brandId: '140', years: [2020, 2021, 2022, 2023, 2024, 2025] },
  { id: '1402', name: 'CPx', slug: 'cpx', brandId: '140', years: [2021, 2022, 2023, 2024, 2025] },
  // Zontes (brandId: 141)
  { id: '1410', name: 'T310', slug: 't310', brandId: '141', years: [2021, 2022, 2023, 2024, 2025] },
  { id: '1411', name: 'R310', slug: 'r310', brandId: '141', years: [2021, 2022, 2023, 2024, 2025] },
  { id: '1412', name: 'U310', slug: 'u310', brandId: '141', years: [2022, 2023, 2024, 2025] },
  { id: '1413', name: '350T', slug: '350t', brandId: '141', years: [2022, 2023, 2024, 2025] },
